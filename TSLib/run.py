...
from modules.print_args import print_args
import random
import numpy as np
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, required=True, default='SegRNN',
                        help='model name, options: [Autoformer, Transformer, TimesNet]')

    # data loader
    parser.add_argument('--data', type=str, required=True, default='ETTh1', help='dataset type')
    # parser.add_argument('--root_path', type=str, default='/home/ma00048/Moji/TSF_data', help='root path of the data file')
